...
if __name__ == "__main__":
    ...
    cs.read_arp_table_file("../examples/stanford/Stanford_backbone/yozb_rtr_arp_table.txt")
    cs.read_mac_table_file("../examples/stanford/Stanford_backbone/yozb_rtr_mac_table.txt")
    cs.read_config_file("../examples/stanford/Stanford_backbone/yozb_rtr_config.txt")
    cs.read_spanning_tree_file("../examples/stanford/Stanford_backbone/yozb_rtr_spanning_tree.txt")
    cs.read_route_file("../examples/stanford/Stanford_backbone/yozb_rtr_route.txt")
